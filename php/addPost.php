...
// Check if the title and content are passed as URL parameters
    ...
    <main>
        <div class="post">
            <form action="/werbsite/php/addEntry.php" method="post" id="postForm">
                ...
                <textarea id="content" name="content" placeholder="Yip yap yop this is a blog..."><?php echo htmlspecialchars($content) ?></textarea>

                <div class="buttons">
                    <input type="submit" name="action" value="Post">
                    <input type="submit" id="previewBtn" name="action" value="Preview">
